...
This means it's possible to *design* better coordination systems, which includes voting systems. Academic fields such as [political economy](https://en.wikipedia.org/wiki/Political_economy) and [game theory](https://en.wikipedia.org/wiki/Game_theory) study these questions, and try to come up with systems that perform better in different ways.

I'm not telling you this because math and logic are all we'll ever need, or that they've already solved all our problems. Logical theories reason about imaginary *models* of the real world, so we need to perform experiments to see if those imaginary models usefully align with the real world. But pure logic is an essential part of progress, since it prevents us from wasting time and resources on clearly flawed experiments, and points us toward possibilities we would never bump into with experiments alone.
...
This book exists to present and explain Persistent Democracy, to explore the ways it can be used to combine, evolve, and generalize many different coordination systems, and plot a practical and realistic course to apply it in the real world.
...
This book isn't structured in the typical way. Since a discussion of coordination systems can easily get extremely wonky and detailed, I've structured this book like a tree with many small branches rather than a typical "straight line" book. The "trunk" of the book is only three main chapters and a conclusion, meaning pretty much anyone can get the big ideas in a single sitting. However each chapter freely points to other "branch" chapters that go into more detail for those interested. The book is published as a website to accommodate the tree structure.
...
Here are the "trunk" chapters that discuss the main points:
...
- [**Partial Common Ownership**](TODO) discusses how Persistent Democracy can be blended with Harberger taxes to keep the useful aspects of private property while breaking cycles of cumulative advantage and ensuring resources tend to be used for socially beneficial purposes.
...
[This page](TODO) is an index of all "branch" chapters. Here are some particularly interesting ones:
...
I'm a skilled software engineer, so it wouldn't be the most effective use of my time to gain the background necessary to give proofs the academic community would actually accept. I hope my proof sketches are interesting enough for daring academics to explore further! Please reach out to me if you decide to do this!
