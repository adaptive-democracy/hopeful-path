...
This book is open source, and a work in progress. [This "tree" will continue to grow.](https://blainehansen.me/post/iterative-media/) Anyone is free to suggest edits or additions by [submitting a pull request on the book's online repository](https://github.com/persistent-democracy/hopeful-path).

Here are the main chapters:

- <chapter-ref slug="/persistent-democracy" text="discusses the central concept, how it can enable direct democracy, and some important details it needs to work properly."/>
- <chapter-ref slug="/common-resource-rights" text="discusses how Persistent Democracy can be blended with Harberger taxes to both maintain the useful aspects of private property without allowing continued cycles of cumulative advantage, and ensure resources tend to be used for socially beneficial purposes."/>
- <chapter-ref slug="/power-of-cooperatives" text="discusses how cooperatives can use Persistent Democracy to finally meet their full potential and help us build a fair and sustainable economy without waiting for government reform."/>
- <chapter-ref slug="/realistic-plan-for-change" text="discusses how a political party and a consumer cooperative both governed using Persistent Democracy can validate Persistent Democracy in the real world and help us slowly take back control of our economies and governments."/>
