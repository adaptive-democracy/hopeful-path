...
- [**Persistent Democracy**](/persistent-democracy) discusses the central concept, how it can enable direct democracy, and some important details it needs to work properly.
- [**Partial Common Ownership**](/partial-common-ownership) discusses how Persistent Democracy can be blended with Harberger taxes to maintain the useful aspects of private property while breaking cycles of cumulative advantage and ensuring resources tend to be used for socially beneficial purposes.
- [**The Power of Cooperatives**](/power-of-cooperatives) discusses how cooperatives can use Persistent Democracy to finally meet their full potential, and allow us to build a fair and sustainable economy without waiting for government reform.
- [**A Realistic Plan for Change**](/realistic-plan-for-change) discusses how the a political party and a consumer cooperative both governed using Persistent Democracy can allow us to validate Persistent Democracy in the real world and slowly take back control of our economies and governments.

The [table of contents](/contents) lists all finished detail chapters. Here are some particularly interesting ones:

- [Why is our democracy broken? An introduction to voting methods and their rippling consequences.](/voting-methods)
- [Software is too important to be constantly broken. Provably correct software is possible and necessary.](/provably-correct-software)
- [Blockchains aren't going to fix society, but Persistent Democracy and cooperatives could.](/blockchains-and-society)

<!-- <ChapterLink slug="/voting-methods" type="list-item"/> -->

## Footnote: is Persistent Democracy provably optimal?

Maybe! I've developed some [*very rough* work-in-progress proof sketches](https://github.com/blainehansen/hopeful-pathway/blob/main/book/theory/toward-verified-foundations.md) that are convincing enough to start sharing the idea and building experimental tools.
