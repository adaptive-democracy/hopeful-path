...
There are tons of specific details to get right when designing a completely new system for democratic decision-making. In this chapter I've already pointed to a few other chapters that dive deeper into finer details, but I'll list them again, along with others I think you might find interesting at this point.
