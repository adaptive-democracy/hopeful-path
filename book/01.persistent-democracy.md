...
If you're curious about tricky questions such as "can a Persistent Constitution be changed into a form that no longer uses persistent voting to choose it?", you should visit the [detailed page about Persistent Constitutions](/persistent-constitutions).
...
Persistent Democracy just as powerfully supports delegation as liquid democracy, but in a simpler way: "delegation by abstention". If you don't care about an issue, or aren't confident you know enough about it to have a useful opinion, just don't vote on it and allow others to make the decision. You can always change your mind and and move weights into that election at some later time. Stabilization buckets should be designed to make more important decisions take longer to change, giving you more time to notice them if you actually do care.
