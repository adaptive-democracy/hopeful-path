...
The unfair concentrations of power in our society [are produced by inefficient definitions of legal control](https://www.thwink.org/sustain/glossary/CumulativeAdvantagePrinciple.htm), and so disrupt the creation of welfare by allowing extractive actors to exert undue power over others. [Partial common ownership](http://assets.press.princeton.edu/chapters/s11222.pdf) was built to solve that problem, but that's not the topic of this essay.
